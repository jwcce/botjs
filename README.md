...
3. Create a file named `storage/config.json`, copy-paste this inside it:
...
4. Create a file named `storage/chall.json` and copy-paste this inside it and write the flag from challenge 1:
```json
{
	"flag1": ""
}
